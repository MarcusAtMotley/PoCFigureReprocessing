#!/bin/bash
# Run P1 DNA SNP Pipeline - Batch 2: Next 3 mTNA samples
# Runs after batch 1 completes
set -e
...
echo "=========================================="
echo "P1 DNA SNP - Batch 2 (3 samples @ ${THREADS_PER_SAMPLE} threads)"
echo "=========================================="
echo "Started: $(date)"
...
# Batch 2 samples
SAMPLE1="CoM_08S_3A2_TNA-mRT-EM"
FQ1_1="$FASTQ_DIR/${SAMPLE1}_merged_R1.fastq"
FQ1_2="$FASTQ_DIR/${SAMPLE1}_merged_R2.fastq"

SAMPLE2="CoB_08X_3A2_TNA-RT-EM"
FQ2_1="$FASTQ_DIR/${SAMPLE2}_merged_R1.fastq"
FQ2_2="$FASTQ_DIR/${SAMPLE2}_merged_R2.fastq"

SAMPLE3="CoM_08Y_3A2_TNA-RT-EM"
...
download_and_merge "$SAMPLE1" "CoM_08S_3A2_TNA-mRT-EM_S4" &
DL_PID1=$!

download_and_merge "$SAMPLE2" "CoB_08X_3A2_TNA-RT-EM_S5" &
DL_PID2=$!

download_and_merge "$SAMPLE3" "CoM_08Y_3A2_TNA-RT-EM_S6" &
DL_PID3=$!

# Wait for first download, then start processing
wait $DL_PID1
echo ""
...
# Wait for second download, then start processing
wait $DL_PID2
echo ""
...
# Wait for third download, then start processing
wait $DL_PID3
echo ""
...
echo ""
echo "=========================================="
echo "P1 DNA SNP Batch 2 Complete!"
echo "=========================================="
echo "Finished: $(date)"
echo "Results:"
